...
export const LandingPage = () => {
  ...
  return (
    <div
      className="min-h-screen font-ibm bg-slate-50"
    ...
    >
      ...
      <nav className="sticky top-0 z-50 backdrop-blur-xl bg-white/80 border-b border-slate-200/60">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-2" data-testid="logo">
            ...
            <span className="text-2xl font-outfit font-semibold text-slate-900">
              Mob Pae
            </span>
          </div>
          ...
          <div className="flex items-center gap-3">
            <Link to="/login">
              <Button
                variant="ghost"
                className="text-slate-700 hover:text-primary hidden sm:inline-flex"
                data-testid="employer-login-nav"
              >
                Sign In
              </Button>
            </Link>
      ...
      >
        <div
          ...
          style={{
            backgroundImage:
              "url(https://static.prod-images.emergentagent.com/jobs/7c8cee12-4131-4033-8d27-b496ae48e677/images/8ee0b9798720e266ea39481c07dd54f2c90752d02b0ff8c57570421ef390504b.png)",
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 backdrop-blur-sm border border-white/20 mb-6">
                ...
                <span className="text-sm text-slate-300">
                  Trusted by 450+ companies across India
                </span>
              </div>

              <h1
                className="text-5xl sm:text-6xl lg:text-7xl font-outfit font-medium tracking-tight text-white mb-6 leading-[1.05]"
              ...
              >
                Mob Pae empowers your workforce with instant access to earned
                wages. Reduce financial stress, boost retention, and offer the
                benefit employees actually use.
              </p>
            ...
            <div className="relative hidden lg:block">
              <div className="absolute -top-8 -left-8 w-64 rounded-2xl bg-white/10 backdrop-blur-xl border border-white/20 p-5 shadow-2xl rotate-[-3deg] hover:rotate-0 transition-transform duration-500">
                ...
                <div className="text-3xl font-outfit font-semibold text-white mb-1">
                  ₹15,000
                </div>
                <div className="text-xs text-slate-400">
                  of ₹50,000 monthly salary
                </div>
              ...
              <div className="relative ml-12 mt-12 rounded-3xl bg-white/95 backdrop-blur-xl shadow-2xl p-8 border border-white/10">
                <div className="flex items-center justify-between mb-6">
                  <div>
                    ...
                    <h3 className="text-2xl font-outfit font-medium text-slate-900">
                      Adoption Growth
                    </h3>
                  </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16 max-w-2xl mx-auto">
            ...
            <p className="text-lg text-slate-600 leading-relaxed">
              A single platform that gives employers control and employees
              freedom.
            </p>
          </div>
      ...
      >
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid lg:grid-cols-3 gap-6">
            {/* Adoption Chart */}
            <div
              className="lg:col-span-2 rounded-3xl bg-slate-50 border border-slate-100 p-8"
              data-testid="adoption-chart"
            >
            ...
            <div
              ...
              data-testid="usecase-chart"
            >
              <p className="text-xs uppercase tracking-[0.2em] text-slate-500 mb-2">
                Top Use Cases
              </p>
              <h3 className="text-xl font-outfit font-medium text-slate-900 mb-6">
            ...
            {/* Disbursement Bar */}
            <div
              className="lg:col-span-3 rounded-3xl bg-[#0A1128] p-8 text-white"
              data-testid="disbursement-chart"
            >
              <div className="flex items-start justify-between mb-6">
                <div>
                  ...
                  <h3 className="text-2xl font-outfit font-medium">
                    ₹ Crores disbursed this year
                  </h3>
                </div>
            ...
            {[
              {
                ...
                desc: "Submit an enquiry and get approved by our team within 24 hours.",
                icon: Building2,
              },
              {
                num: "02",
                title: "Add Employees",
                desc: "Upload your workforce and set personalised advance limits.",
                icon: Users,
              },
              {
                num: "03",
                title: "Instant Advances",
                desc: "Employees request, you approve, advance is disbursed.",
                icon: Zap,
              },
            ].map((step, i) => {
              ...
              return (
                <div
                  key={i}
                  className="relative rounded-3xl bg-white border border-slate-100 p-8 shadow-[0_8px_30px_rgb(0,0,0,0.04)] transition-all hover:-translate-y-1 hover:shadow-xl"
                ...
                >
                  ...
                  <h3 className="text-xl font-outfit font-medium mb-3 text-slate-900">
                    {step.title}
                  </h3>
              ...
              items={[
                {
                  ...
                  desc: "Companies report 28% lower attrition after rolling out Mob Pae.",
                },
                {
                  title: "Zero Setup Cost",
                  desc: "No upfront fees. No payroll integration headaches. Live in 48 hours.",
                },
                {
                  title: "Auto Reconciliation",
                  desc: "Advances auto-deduct from payroll — no manual work for HR.",
                },
                {
                  title: "Wellness Metrics",
                  desc: "See financial wellness trends across your entire workforce.",
                },
              ]}
              ...
              items={[
                {
                  ...
                  desc: "It's your earned salary. No interest charges, no hidden fees.",
                },
                {
                  title: "No Credit Check",
                  desc: "Eligibility based on your earned salary, not your credit score.",
                },
                {
                  title: "24/7 Access",
                  desc: "Request advances anytime — weekends, holidays, emergencies.",
                },
                {
                  title: "Private & Secure",
                  desc: "Your employer sees only what they need. Bank-level encryption.",
                },
              ]}
      ...
      <section id="faq" className="py-24 bg-white" data-testid="faq-section">
        <div className="max-w-3xl mx-auto px-6">
          ...
          <div className="space-y-3">
            {[
              {
                q: "Is this a loan? Do employees pay interest?",
                a: "No. Mob Pae is salary advance, not a loan. Employees access only what they've already earned. Zero interest, zero hidden fees.",
              },
              {
                q: "How long does employer onboarding take?",
                a: "Most employers go live within 48 hours. Submit an enquiry, our team reviews, and we set up your account.",
              },
              {
                q: "What's the advance limit?",
                a: "Employers set the limit per employee — typically 20-40% of monthly salary. You have full control.",
              },
              {
                q: "Is this RBI compliant?",
                a: "Yes. Mob Pae is built to be fully RBI compliant. No NBFC partnership needed in our MVP — advances are employer-backed.",
              },
              {
                q: "What if an employee leaves?",
                a: "Any outstanding advance is settled in their final settlement. Mob Pae handles the reconciliation automatically.",
              },
            ].map((item, i) => (
              <div
                key={i}
          ...
          <div className="relative rounded-3xl bg-[#0A1128] overflow-hidden p-12 sm:p-20 text-center">
            ...
            <div className="relative z-10">
              ...
              <p className="text-lg text-slate-300 mb-10 max-w-xl mx-auto">
                Join 450+ companies using Mob Pae. Setup takes 48 hours. No
                credit card needed.
              </p>
              <Button
                onClick={() => setShowEnquiry(true)}
      ...
      {/* Footer */}
      <footer
        className="bg-[#0A1128] text-slate-300 py-16"
        data-testid="footer"
      >
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-5 gap-8 mb-12">
            <div className="md:col-span-2">
              <div className="flex items-center gap-2 mb-4">
                ...
                <span className="text-2xl font-outfit font-semibold text-white">
                  Mob Pae
                </span>
              </div>
              <p className="text-sm leading-relaxed max-w-sm text-slate-400">
                Empowering India's workforce with on-demand salary access. Built
                with care, secured with care.
              </p>
            </div>
            <FooterCol
              title="Product"
              items={["For Employers", "For Employees", "Pricing", "Security"]}
            />
            <FooterCol
              title="Company"
            ...
            <FooterCol
              title="Legal"
              items={["Privacy", "Terms", "Compliance", "Contact"]}
            />
          </div>
          <div className="border-t border-slate-800 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-sm text-slate-500">
            ...
            <div className="flex items-center gap-4">
              <span className="flex items-center gap-1.5">
                <Shield className="h-4 w-4" /> RBI Compliant
              </span>
              <span className="flex items-center gap-1.5">
...
const StatTile = ({ value, label }) => (
  <div className="text-center">
    <div className="text-3xl sm:text-4xl font-outfit font-semibold text-slate-900 mb-2">
      {value}
    </div>
...
const FeatureCard = ({
  ...
  <div
    className="group rounded-3xl bg-white border border-slate-100 p-8 shadow-[0_8px_30px_rgb(0,0,0,0.04)] transition-all hover:-translate-y-1 hover:shadow-xl"
    data-testid={testId}
  >
    ...
    <h3 className="text-2xl font-outfit font-medium mb-3 text-slate-900">
      {title}
    </h3>
    <p className="text-slate-600 leading-relaxed mb-6">{description}</p>
    <div className="pt-6 border-t border-slate-100">
      <div className="text-2xl font-outfit font-semibold text-slate-900">
        {metric}
      </div>
...
const BenefitColumn = ({ title, tag, accent, items, testId }) => (
  <div data-testid={testId}>
    <div
      className={`inline-block px-3 py-1 rounded-full text-xs font-medium ${accent} mb-4`}
    >
      {tag}
    </div>
    <h2 className="text-3xl sm:text-4xl font-outfit font-medium tracking-tight text-slate-900 mb-8">
      {title}
    </h2>
        ...
        <div className="p-6 sm:p-10">
          <div className="flex items-center justify-between mb-6">
            <div>
              ...
              <h2 className="text-2xl sm:text-3xl font-outfit font-medium">
                Talk to Sales
              </h2>
            </div>
            <button
          ...
          {success ? (
            <div className="text-center py-10" data-testid="success-message">
              ...
              <h3 className="text-2xl font-outfit font-medium mb-2">
                Enquiry Submitted!
              </h3>
            ...
            >
              <div className="grid sm:grid-cols-2 gap-4">
                ...
                <Input
                  ...
                  onChange={(v) =>
                    setFormData({ ...formData, contact_person_name: v })
                  }
                />
                <Input
                  label="Work Email *"
                  ...
                  onChange={(v) => setFormData({ ...formData, work_email: v })}
                />
                <Input
                  label="Phone *"
                  type="tel"
                ...
                <Input
                  ...
                  type="number"
                  testId="num-employees-input"
                  value={formData.number_of_employees}
                  onChange={(v) =>
                    setFormData({ ...formData, number_of_employees: v })
                  }
                />
                <div>
              ...
              <Input
                label="Payroll Software (Optional)"
                testId="payroll-software-input"
                required={false}
                value={formData.payroll_software}
                onChange={(v) =>
                  setFormData({ ...formData, payroll_software: v })
                }
              />
              <div>
                <label className="block text-sm font-medium mb-2">
              ...
              <Button
                type="submit"
                disabled={loading}
                className="w-full rounded-xl py-6 text-base bg-primary hover:bg-blue-700"
